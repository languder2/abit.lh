        ...
        <div class="row row-cols-1 row-cols-sm-1 row-cols-md-4 px-2 pt-5 mt-5" style="max-width: 1320px; margin: 0 auto;">
            ...
            <div class="col mb-3">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item mb-2"><a href="tel:+79900215716" class="nav-link p-0 text-muted">+7(990) 021-57-16</a></li>
                </ul>
            </div>
...
<?php echo view("public/template/fb");?>
<?php echo view("public/template/YandexMetric")?>
<script>
    function searchDepartments() {
        // Получаем значение из поля поиска
        if(document.getElementById("search-depart")){
